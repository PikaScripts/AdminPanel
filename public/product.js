...
currentrows = element.parentNode.parentNode;
...
function edit() {
  ...
  editcontainer.forEach((item) => {
    ...
    <div class="container">
      <svg width="34" height="34" onclick="editmodals(this)" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg width="34" height="34" onclick="deletemodals(this)"  class="delete" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  currentrows.innerHTML = editblocks
  })
