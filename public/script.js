...
let inputname = document.querySelector('.modal .containerInput .names')
      ...
      containerInput.forEach((item) => {
        ...
        <div class="container">
          <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg width="34" height="34" class="delete" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
